...
async function main() {
    console.log('🌱 Starting to seed 6 rich articles...')
    ...
    if (!adminUser) {
        throw new Error('Admin user not found, cannot seed articles without an author.')
    }
...
Data defeats hesitation.`,
    ...
    console.log('🎉 6 new rich articles successfully seeded!')
}
