module.exports = [
"[project]/app/admin/debug/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DebugPage() {
    ...
    const runTest = async ()=>{
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('testimonials').select('count', {
                count: 'exact',
                head: true
            });
            if (error) {
