  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        // Fluid typography
        'fluid-h1': ['clamp(2.5rem, 5vw + 1rem, 6rem)', { lineHeight: '1.1' }],
        'fluid-h2': ['clamp(2rem, 4vw + 1rem, 4.5rem)', { lineHeight: '1.2' }],
        'fluid-h3': ['clamp(1.5rem, 3vw + 1rem, 3rem)', { lineHeight: '1.3' }],
        'fluid-p': ['clamp(1rem, 1.5vw + 0.5rem, 1.25rem)', { lineHeight: '1.6' }],
      },
      colors: {
      ...
      boxShadow: {
        'glow': '0 0 20px hsl(var(--accent) / 0.5)',
