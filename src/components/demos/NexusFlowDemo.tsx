            ...
            >
                ...
                <div className="border-b border-white/5 bg-white/[0.02] px-8 py-6 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-sm font-bold text-white uppercase tracking-widest">Nexus_Flow</h2>
                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex flex-col items-end">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xl font-bold text-white italic">{conversionRate}%</span>
                            </div>
                            <span className="text-[8px] text-white/40 font-bold uppercase tracking-widest">Global_CVR</span>
                        </div>
                ...
                <div className="grid lg:grid-cols-12 h-[500px]">
                    ...
                    <div className="lg:col-span-7 border-r border-white/5 p-8 relative overflow-hidden">
                        ...
                        <div className="flex items-center justify-between mb-8">
                            <h3 className="text-xs font-bold text-white/40 uppercase tracking-[0.3em]">Funnel_Metrics</h3>
                            ...
                            {[
                                ...
                                >
                                    <div className="flex justify-between items-end mb-2">
                                        <span className="text-[10px] font-bold text-white/40 tracking-widest">{step.label}</span>
                                        <span className={`text-sm font-bold transition-colors ${isHovered === step.label ? 'text-purple-400' : 'text-white/80'}`}>{step.value}</span>
                                    </div>
                        ...
                        <div className="mt-12 bg-white/[0.02] border border-white/10 rounded-2xl p-6 relative overflow-hidden group">
                            <div className="flex items-start justify-between relative z-10">
                                <div>
                                    <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-2">Predicted_Lift</h4>
                                    <div className="text-3xl font-bold text-white italic">+127%</div>
                                </div>
                    ...
                    <div className="lg:col-span-5 bg-white/[0.01] p-8 flex flex-col justify-between">
                        <div>
                            <div className="mb-8">
                                <h3 className="text-xs font-bold text-white/40 uppercase tracking-[0.3em] mb-2">Pricing_Engine_v2</h3>
                        ...
                        <div className="mt-8">
                            <button className="w-full py-5 bg-white text-black font-bold uppercase tracking-[0.3em] text-xs rounded-2xl flex items-center justify-center gap-2 hover:bg-purple-500 hover:text-white transition-all duration-500 shadow-[0_20px_40px_rgba(255,255,255,0.05)] active:scale-95 group">
                                Start Your Test
                                <ArrowUpRight className="w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                            </button>
                            <p className="text-center mt-4 text-[8px] text-white/20 font-bold uppercase tracking-widest">No_Credit_Card_Required_•_Lab_Verified</p>
                        </div>
                    </div>
                </div>
            </motion.div>
