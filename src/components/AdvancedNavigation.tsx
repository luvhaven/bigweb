...
const NAV_LINKS = [
  ...
  },
  {
    ...
    href: '/services',
    children: [
      { label: 'Website Engineering', href: '/services/web-development', desc: 'Next.js platforms engineered to convert' },
      { label: 'Mobile Applications', href: '/services/mobile-apps', desc: 'iOS & Android products built to dominate' },
      { label: 'UI/UX Product Design', href: '/services/ui-ux-design', desc: 'Interfaces that drive action, not admiration' },
      { label: 'SEO & GAIO Authority', href: '/services/seo', desc: 'Organic visibility and AI search dominance' },
      { label: 'E-Commerce Systems', href: '/services/ecommerce', desc: 'Frictionless transaction infrastructure' },
      { label: 'AI Automation', href: '/services/ai-automation', desc: 'Profit-generating AI agent workflows' },
      { label: 'Analytics & Intelligence', href: '/services/analytics', desc: 'Forensic data, actionable decisions' },
      { label: 'Managed Maintenance', href: '/services/maintenance', desc: '24/7 zero-downtime site management' },
    ],
  },
  {
    label: 'Packages',
    href: '/#pricing',
    children: [
      { label: 'Revenue Roadmap', href: '/offers/revenue-roadmap', desc: 'Strategic deep-dive & growth blueprint', tag: 'Popular' },
      { label: 'The Monolith™ System', href: '/offers/revenue-system', desc: 'Full-stack website + conversion engine', tag: 'Best Value' },
      { label: 'Growth Retainer', href: '/offers/retainer', desc: 'Ongoing optimization & continuous growth' },
    ],
  },
