  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95 uppercase tracking-widest",
  {
    variants: {
      variant: {
        ...
        luxury: "bg-gradient-to-br from-[#1a1a1a] to-black text-white border border-white/10 shadow-2xl hover:border-accent/40 hover:shadow-accent/20 hover:scale-[1.02] relative overflow-hidden font-black",
        conversion: "bg-foreground text-background hover:bg-foreground/90 shadow-[0_0_50px_-10px_rgba(var(--accent),0.5)] hover:shadow-[0_0_60px_-5px_rgba(var(--accent),0.6)] hover:-translate-y-1 transition-all font-black",
