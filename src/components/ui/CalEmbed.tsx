...
export default function CalEmbed({ calLink = 'bigwebdigital/revenue-diagnostic' }: CalEmbedProps) {
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      Cal("init", "revenue-diagnostic", { origin: "https://app.cal.com" });
      Cal.ns["revenue-diagnostic"]("inline", {
        elementOrSelector: "#cal-booking-embed",
        calLink: "${calLink}",
        layout: "month_view",
        theme: "dark",
      });
      Cal.ns["revenue-diagnostic"]("ui", {
