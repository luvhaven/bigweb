...
export default function RevenueWebsitePage() {
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-emerald-500/30 overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 z-10">
                <div className="container mx-auto px-4 max-w-6xl text-center">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-4 py-1.5 text-emerald-400 text-sm font-semibold mb-6 backdrop-blur-md hover:bg-emerald-500/20 transition-colors cursor-default"
                    >
                    ...
                    <motion.h1
                        ...
                        className="text-5xl md:text-8xl font-extrabold tracking-tight mb-6 leading-[1.1] md:leading-[1.1]"
                    >
                    ...
                    >
                        <Link
                            href="#pricing"
                            className="group relative bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-lg px-10 py-5 rounded-2xl shadow-2xl shadow-emerald-500/30 transition-all hover:scale-105 flex items-center gap-2 overflow-hidden"
                        >
                ...
                <div className="container mx-auto px-4 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-20 items-center">
                        ...
                        <TiltCard className="perspective-1000">
                            <Image
                                src="/images/speed-chart.png"
                                alt="Speed Comparison Chart"
                                width={600}
                                height={400}
            ...
            <section className="py-24 bg-black z-10 relative">
                <div className="container mx-auto px-4 max-w-6xl">
