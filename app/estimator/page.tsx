        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-3 px-6 py-2 rounded-full backdrop-blur-3xl bg-white/5 border border-accent/20 mb-12 shadow-[0_0_30px_rgba(249,115,22,0.1)]"
            >
              <FlaskConical className="w-4 h-4 text-accent-light" />
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-accent-light">
            ...
            <p className="text-xl md:text-3xl text-zinc-400 leading-tight max-w-4xl mx-auto mb-16 font-light">
              Calculate your potential yield and identify <strong className="text-white font-black italic underline decoration-accent underline-offset-8">revenue leakage targets</strong>.
      ...
      <section className="py-40 border-t border-white/5 bg-[#080808]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-4xl md:text-6xl font-black text-white uppercase italic tracking-tighter">The Audit <span className="text-accent">Cycle</span></h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            {[
              ...
              <div key={i} className="p-12 rounded-[3.5rem] bg-black border border-white/5 relative group hover:border-accent/30 transition-all duration-500">
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto p-16 md:p-32 rounded-[4rem] bg-white/[0.02] border border-white/5 shadow-2xl">
            ...
            <div className="flex flex-wrap justify-center gap-8 items-center opacity-50">
              <div className="flex items-center gap-2 text-xs font-black uppercase tracking-widest"><CheckCircle2 className="w-5 h-5 text-accent" /> 100% Secure Data</div>
              <div className="flex items-center gap-2 text-xs font-black uppercase tracking-widest"><CheckCircle2 className="w-5 h-5 text-accent" /> Professional Audit</div>
              <div className="flex items-center gap-2 text-xs font-black uppercase tracking-widest"><CheckCircle2 className="w-5 h-5 text-accent" /> Actionable Yield</div>
            </div>
          </div>
        </div>
      </section>
